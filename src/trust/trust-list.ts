...
const EU_TRUSTED_ISSUERS: ReadonlyMap<string, TrustedIssuerInfo> = new Map([
  ...
  ['did:web:pid-issuer.bundesdruckerei.de', { name: 'German PID Issuer (Bundesdruckerei)', country: 'DE' }],
  // French EUDIW pilot (ANTS)
  ['did:web:pid.ants.gouv.fr', { name: 'French PID Issuer (ANTS)', country: 'FR' }],
  // Spanish EUDIW pilot
  ...
  ['did:ebsi:conformance', { name: 'EBSI Conformance Test Issuer', country: 'EU' }],
])
